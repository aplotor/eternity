	...
	<div id="unlock_container" class="card card-body bg-dark text-left mt-3 pb-3">
		<div class="form-group">
			<div class="text-center">
				...
				<span bind:this={instruction_video_wrapper} class="no_bullet embed-responsive embed-responsive-16by9 d-none"><iframe title="firebase setup guide" class="embed-responsive-item" src="https://www.youtube.com/embed/zow7LnO2bnw" allow="fullscreen"></iframe></span>
			</div>
