	...
	<div id="unlock_container" class="card card-body bg-dark text-left mt-3 pb-3">
		<div class="form-group">
			...
			<ul class="line_height_1 mt-n2">
				...
				<li class="mt-2">create a new Firebase project <span class="text-light">named <b>{(username.includes("_") ? `ete-000-${username.toLowerCase().split("_").join("-")}` : `eternity-${username.toLowerCase()}`)}</b></span></li>
